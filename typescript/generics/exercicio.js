...
function fazerSubstituicao(jogadorSaindo, jogadorEntrando) {
    console.log(`Sai: ${jogadorSaindo.nome} 🔄 Entra: ${jogadorEntrando.nome}`);
    return jogadorEntrando;
}
const goleiroTitular = { posicao: "goleiro", nome: "Alisson", defesas: 5 };
const goleiroReserva = { posicao: "goleiro", nome: "Ederson", defesas: 2 };
const atacanteTitular = { posicao: "atacante", nome: "Vini Jr", gols: 15 };
const atacanteReserva = { posicao: "atacante", nome: "Rodrygo", gols: 8 };
